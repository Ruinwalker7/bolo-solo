...
admin.uploadFile={init:function(e){$("#single_upload").change((function(){if(this.files.length>0){var e=this.files[0];"text/markdown"===e.type||e.name.endsWith(".md")?admin.uploadFile.uploadMarkdown(e):(alert("\u8bf7\u4e0a\u4f20.md\u6587\u4ef6\uff01"),this.value="")}})),$("#drop_zone_single").click((function(){$("#single_upload").click()})),$("#drop_zone_single").on("dragover",(function(e){e.preventDefault(),e.dataTransfer.dropEffect="copy",this.textContent="\u91ca\u653e\u4ee5\u4e0a\u4f20\u6587\u4ef6"})),$("#drop_zone_single").on("dragenter",(function(e){this.textContent="\u91ca\u653e\u4ee5\u4e0a\u4f20\u6587\u4ef6"})),$("#drop_zone_single").on("dragleave",(function(e){this.textContent="\u70b9\u51fb\u6216\u5728\u6b64\u533a\u57df\u62d6\u62fd\u56fe\u7247\u4ee5\u4e0a\u4f20"})),$("#drop_zone_single").on("drop",(function(e){e.preventDefault(),this.textContent="\u70b9\u51fb\u6216\u5728\u6b64\u533a\u57df\u62d6\u62fd\u56fe\u7247\u4ee5\u4e0a\u4f20";var n=e.originalEvent.dataTransfer.files;1===n.length&&n[0].name.endsWith(".md")?(console.log("\u51c6\u5907\u4e0a\u4f20\u6587\u4ef6\uff1a",n[0].name),admin.uploadFile.uploadMarkdown(n[0])):alert("\u8bf7\u62d6\u62fd\u5355\u4e2aMarkdown\u6587\u4ef6\uff01")})),$("#drop_zone_multi").click((function(){$("#multi_upload").click()})),$("#drop_zone_multi").on("dragover",(function(e){e.preventDefault(),e.dataTransfer.dropEffect="copy",this.textContent="\u91ca\u653e\u4ee5\u4e0a\u4f20\u6587\u4ef6"})),$("#drop_zone_multi").on("dragenter",(function(e){this.textContent="\u91ca\u653e\u4ee5\u4e0a\u4f20\u6587\u4ef6"})),$("#drop_zone_multi").on("dragleave",(function(e){this.textContent="\u70b9\u51fb\u6216\u5728\u6b64\u533a\u57df\u62d6\u62fd\u56fe\u7247\u4ee5\u4e0a\u4f20"})),$("#drop_zone_multi").on("drop",(function(e){e.preventDefault(),this.textContent="\u70b9\u51fb\u6216\u5728\u6b64\u533a\u57df\u62d6\u62fd\u56fe\u7247\u4ee5\u4e0a\u4f20";var n=e.originalEvent.dataTransfer.files;admin.uploadFile.uploadPictures(n)})),$("#multi_upload").change((function(){admin.uploadFile.uploadPictures(this.files)}))},uploadMarkdown:function(e){var n=new FormData;n.append("file",e),$.ajax({url:"/console/upload/markdown",type:"POST",data:n,processData:!1,contentType:!1,success:function(){$("#drop_zone_single").hide(),$("#fileName").text(e.name),$("#uploadSuccess").show()},error:function(){alert("File upload failed")}})},uploadPictures:function(e){for(let t=0;t<e.length;t++){let o=e[t];if(!o.type.startsWith("image/")){alert("\u4ec5\u652f\u6301\u56fe\u7247\u6587\u4ef6\uff01");continue}let a=new FormData;for(var n=0;n<e.length;n++)a.append("files[]",e[n]);$.ajax({url:"/console/upload/pictures",type:"POST",data:a,processData:!1,contentType:!1,success:function(e){-1!=e.code&&e.rslts.forEach((function(e){admin.uploadFile.addImage("/markdowns/assets/"+e,e)}))},error:function(){alert("\u8fde\u63a5\u670d\u52a1\u5668\u5931\u8d25\uff01")}});let i=document.createElement("li");i.textContent=o.name,$("#file_list_multi").appendChild(i)}},showDiv:function(){$.ajax({url:"/console/upload/clean",type:"GET",processData:!1,contentType:!1,success:function(){$("#uploadDiv").show(),$("#imagesURLInput").val("./assets/"),$("#imagesURLInput").prop("disabled",!0),$("#confirmBtn").hide(),$("#drop_zone_single").show(),$("#uploadSuccess").hide()},error:function(){alert("\u8fde\u63a5\u670d\u52a1\u5668\u5931\u8d25\uff01")}})},addImage:function(e,n){const t=document.getElementById("imageContainer"),o=document.createElement("img");o.src=e,o.alt=n;const a=document.createElement("div");a.classList.add("image-name"),a.textContent=n;const i=document.createElement("div");i.classList.add("image-box"),i.appendChild(o),i.appendChild(a),t.appendChild(i)},refresh:function(){$("#imagesURLInput").prop("disabled",!1),$("#imagesURLInput").val(""),$("#uploadDiv").hide(),$("#confirmBtn").show()}},admin.register["upload-file"]={obj:admin.uploadFile,init:admin.uploadFile.init,refresh:admin.uploadFile.refresh};
