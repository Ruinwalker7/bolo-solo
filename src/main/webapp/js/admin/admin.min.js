...
admin.uploadFile={init:function(e){document.getElementById("single_upload").addEventListener("change",(function(e){if(this.files.length>0){let e=this.files[0];"text/markdown"===e.type||e.name.endsWith(".md")||(alert("\u8bf7\u4e0a\u4f20.md\u6587\u4ef6\uff01"),this.value="")}}));let t=document.getElementById("drop_zone_multi"),n=document.getElementById("file_list_multi");function i(e){for(let t=0;t<e.length;t++){let i=e[t];if(!i.type.startsWith("image/")){alert("\u4ec5\u652f\u6301\u56fe\u7247\u6587\u4ef6\uff01");continue}let d=document.createElement("li");d.textContent=i.name,n.appendChild(d)}}t.addEventListener("dragover",(function(e){e.preventDefault(),e.dataTransfer.dropEffect="copy"})),t.addEventListener("dragover",(function(e){e.preventDefault(),e.dataTransfer.dropEffect="copy",this.textContent="\u91ca\u653e\u4ee5\u4e0a\u4f20\u6587\u4ef6"})),t.addEventListener("dragenter",(function(e){this.textContent="\u91ca\u653e\u4ee5\u4e0a\u4f20\u6587\u4ef6"})),t.addEventListener("dragleave",(function(e){this.textContent="\u6216\u5728\u6b64\u533a\u57df\u62d6\u62fd\u56fe\u7247\u4ee5\u4e0a\u4f20"})),t.addEventListener("drop",(function(e){e.preventDefault(),this.textContent="\u6216\u5728\u6b64\u533a\u57df\u62d6\u62fd\u56fe\u7247\u4ee5\u4e0a\u4f20",i(e.dataTransfer.files)})),document.getElementById("multi_upload").addEventListener("change",(function(e){i(this.files)}))}},admin.register["upload-file"]={obj:admin.uploadFile,init:admin.uploadFile.init};
