...
admin.uploadFile={uploadMarkdown:function(e){var t=new FormData;t.append("file",e),console.log(e),console.log(t),$.ajax({url:"/console/upload/markdown",type:"POST",data:t,processData:!1,contentType:!1,success:function(e){alert("File uploaded successfully")},error:function(){alert("File upload failed")}})},init:function(e){$("#single_upload").change((function(e){if(this.files.length>0){var t=this.files[0];console.log(this.files),console.log(t),"text/markdown"===t.type||t.name.endsWith(".md")?admin.uploadFile.uploadMarkdown(t):(alert("\u8bf7\u4e0a\u4f20.md\u6587\u4ef6\uff01"),this.value="")}}));let t=$("#drop_zone_multi");t.on("dragover",(function(e){e.preventDefault(),e.dataTransfer.dropEffect="copy",this.textContent="\u91ca\u653e\u4ee5\u4e0a\u4f20\u6587\u4ef6"})),t.on("dragenter",(function(e){this.textContent="\u91ca\u653e\u4ee5\u4e0a\u4f20\u6587\u4ef6"})),t.on("dragleave",(function(e){this.textContent="\u70b9\u51fb\u6216\u5728\u6b64\u533a\u57df\u62d6\u62fd\u56fe\u7247\u4ee5\u4e0a\u4f20"})),t.on("drop",(function(e){e.preventDefault(),this.textContent="\u70b9\u51fb\u6216\u5728\u6b64\u533a\u57df\u62d6\u62fd\u56fe\u7247\u4ee5\u4e0a\u4f20";let t=e.dataTransfer.files;admin.uploadFile.uploadPictures(t)})),$("#multi_upload").change((function(e){admin.uploadFile.uploadPictures(this.files)}))},uploadPictures:function(e){for(let t=0;t<e.length;t++){let n=e[t];if(!n.type.startsWith("image/")){alert("\u4ec5\u652f\u6301\u56fe\u7247\u6587\u4ef6\uff01");continue}let l=document.createElement("li");l.textContent=n.name,$("#file_list_multi").appendChild(l)}}},admin.register["upload-file"]={obj:admin.uploadFile,init:admin.uploadFile.init};
